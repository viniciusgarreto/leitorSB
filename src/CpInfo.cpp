...
{
  int64_t longTest = ((uint64_t) m.high_bytes << 32) | ((uint64_t) m.low_bytes);
...
{
  int64_t doubleTest = ((uint64_t) m.high_bytes << 32) | ((uint64_t) m.low_bytes);
