...
Instruction* Instruction::setInstructions() {
    Instruction* instruc =
...
ostream& Instruction::print(ostream& output) const {
    ...
    for (int i = 0; i < 200; i++) {
        ...
        output << "Opcode: " << this->opcode << endl;
        output << "Argum " << this->argnum << endl;
        output << "Opnum " << this->opnum << endl;
        output << "Instruct_pc: " << this->instruct_pc << endl;
    }
