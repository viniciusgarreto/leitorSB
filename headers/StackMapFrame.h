...
Um Stack Map Frame especifica (explícita ou implicitamente) o deslocamento de bytecode em
que se aplica, e os tipos de verificação de variáveis locais e pilha de operandos
entradas para esse deslocamento.
*/
class StackMapFrame {
  public:
    /// Construtor
